                                        ...
                                        <?php  foreach($news as $key => $item):?>
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    <img src="<?= $item['news_image'] ? assets('/uploads/'.$item['news_image']) : assets('\/uploads/no_image.jpg') ?>" alt="Product Image" class="product-img me-2" style="width:250px; height:80px;">
