   ...
   <div class="container-fluid px-4">
      ...
      <div class="row justify-content-center">
         <div class="col-md-8">
            ...
            <?php endif ; ?>
            <h1 class="mb-4">Global Partners Page</h1>
         ...
         <div class="col-md-8">
            <div class="row">
                ...
                function submitRegionForm(event) {
                    ...
                    document.getElementById('regionCountryForm').submit(); // Submit only the region form
                }
                </script>
            ...
            <div class="row">
                ...
                <hr class="hr">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="company_details" id="company_details" class="form-control" placeholder="Enter the page content here...">
                ...
                function addGlobal(event) {
                    event.preventDefault(); // Prevent the default form submission
                    document.getElementById('addGlobalPartnersForm').submit(); // Submit only the region form
                }
                function UpdateGlobal(event){
                    event.preventDefault(); // Prevent the default form submission
                    document.getElementById('UpdateGlobalPartnersEdit').submit(); // Submit only the region form
                }
                </script>
...
<script>
    ...
    function ContentTrim() {
        ...
        document.getElementById("OgDesription").innerHTML = (document.getElementById("OgDesription").innerHTML).trim() ;
         ...
         document.getElementById("company_details").innerHTML = (document.getElementById("company_details").innerHTML).trim() ;
