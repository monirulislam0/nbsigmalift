          ...
          <?php if(session_get("message")) : ?>
            ...
            <form action="/admin/product/store" method="post" enctype="multipart/form-data" style="padding-bottom: 100px;">
              ...
              <div class="mb-3">
                ...
                <input type="number" id="productPrice" class="form-control" placeholder="Enter price" min="1" name="productPrice" value="<?= old("productPrice") ?>">
              ...
              <!-- Product Description -->
              <div class="mb-3">
                <label for="productShortDescription" class="form-label">Description</label>
                ...
                <?php 
                        if(error("productShortDescription")):
                    ?>
              ...
              <div class="mb-3">
                <label for="productLongDescription" class="form-label">Description</label>
