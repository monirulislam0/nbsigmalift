                                    ...
                                    <div class="mb-3 p-2">
                                        ...
                                        <form action="/admin/category/update" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <img src="<?= assets("/uploads/".$category['category_image'])?>" alt=""  id="show_image" style="width: 100px ; height : 80px ;">
                            ...
                            <div class="col-xl-6">
                                 ...
                                 <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <td><img src="<?= assets("/uploads/".$value['category_image'])?>" alt="" style="width: 80px; height : 30px;"></td>
                                        <td>
