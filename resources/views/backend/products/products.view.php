                                        ...
                                        <?php  foreach($products as $key => $product):?>
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    <img src="<?= $product['product_thumbnail'] ? assets('/uploads/'.$product['product_thumbnail']) : assets('\/uploads/no_image.jpg') ?>" alt="Product Image" class="product-img me-2" style="width:250px; height:80px;">
