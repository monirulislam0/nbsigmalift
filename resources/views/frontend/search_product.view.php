    ...
    <div class="container py-5">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-4 mb-4 product-item" data-category="electronics">
                       ...
                       <div class="card">
                        <div style="
                            ...
                            <div class="card-body">
                                <h5 class="card-title text-center bold"><?= $product['product_title'] ?> </h5>
                                <p class="card-text text-center"><span>Model : </span> <?= $product['product_model'] ?> </p>
                            </div>
                        </div>
                       </a>
                    </div>
                ...
                <?php if(empty($products)) echo "<h2 style='padding: 10px'>No Products Search for <b>$search_key</b> !!</h2>"?>
            </div>
            <style>
            .pagination {
