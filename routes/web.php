...
Router::get('/news/{slug}',[NewsController::class,'SingleNews']);
Router::get('/certificate',[FrontendController::class, 'certificate']);
Router::get('/company-profile',[FrontendController::class, 'company_profile']);
Router::get('/global-partners',[FrontendController::class, 'global_partner']);
Router::get('/projects',[FrontendController::class, 'project']);
Router::get('/news',[FrontendController::class, 'news']);
